...
public class CatalogServicesLocator extends org.apache.axis.client.Service implements uno.vendor.service.CatalogServices {

    public CatalogServicesLocator() {
    }


    public CatalogServicesLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public CatalogServicesLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for CatalogServicesImplPort
    private java.lang.String CatalogServicesImplPort_address = "http://localhost:8080/Training_Vendor_Service/CatalogServices";
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.vendor.uno/", "CatalogServices");
    }
